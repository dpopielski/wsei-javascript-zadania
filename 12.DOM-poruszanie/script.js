...
//1
const result1 = document.querySelectorAll(
  "#ex6 > div:first-child > div:first-child > div:first-child"
);

//2
const firstChildEx6 = document.querySelector("#ex6 > div:first-child");
const firstParentEx6 = firstChildEx6.closest("div");
const twoNextChildrenEx6 = firstParentEx6.querySelector(
...
const result3 = parentDivFoo.querySelector(
